export const themeStyles = {
  dark: {
    ...
    pagination: {
      ...
      button:
        'join-item btn w-[3rem] bg-slate-700 text-blue-300 border-blue-300/20 hover:bg-slate-600 transition-colors',
  ...
  light: {
    ...
    pagination: {
      wrapper: 'bg-white',
      button:
        'join-item btn w-[3rem] bg-gray-50 text-gray-700 border-gray-200 hover:bg-gray-100 transition-colors',
